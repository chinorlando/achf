...
--
-- Servidor: localhost
-- Tiempo de generación: 27-07-2020 a las 17:01:54
...
CREATE TABLE `inscripcionequipo` (
  ...
  `id_personacargo` int NOT NULL,
  `id_club` int NOT NULL,
  `genero` varchar(9) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `id_categoria` int NOT NULL,
  `fecha` date NOT NULL,
...
(11, 203, 15, 'M', 1, '2020-07-01', NULL, NULL);
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_equipo`  AS  select `inscripcionequipo`.`id_inscripcionequipo` AS `id_inscripcionequipo`,`club`.`nombre_club` AS `nombre_club`,`categoria`.`nombre` AS `nombre` from (((`inscripcionjugador` join `inscripcionequipo` on((`inscripcionequipo`.`id_inscripcionequipo` = `inscripcionjugador`.`id_inscripcionequipo`))) join `club` on((`club`.`id_club` = `inscripcionequipo`.`id_club`))) join `categoria` on((`categoria`.`id_categoria` = `inscripcionequipo`.`id_categoria`))) group by `inscripcionequipo`.`id_inscripcionequipo` ;
...
--
ALTER TABLE `arbitro_partido`
  MODIFY `id_arbitropartido` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `inscripcionequipo`
  MODIFY `id_inscripcionequipo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `pagogeneral`
  MODIFY `id_pagogeneral` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `resultado_partido`
  MODIFY `id_resultadopartido` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `suspencion`
  MODIFY `id_suspencion` int NOT NULL AUTO_INCREMENT;
