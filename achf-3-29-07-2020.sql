...
--
-- Servidor: localhost
-- Tiempo de generación: 30-07-2020 a las 00:29:19
...
CREATE TABLE `partidos` (
  ...
  `estado` int DEFAULT NULL COMMENT '1=Finalizado 0=No Finalizado',
...
(1, 1, '2020-07-31 00:37:00', NULL, 0, 5, 2, 1, 2, 1),
...
--
ALTER TABLE `categoriasorteado`
  MODIFY `id_categoriasorteado` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `equipo`
  MODIFY `id_equipo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `inscripcionequipo`
  MODIFY `id_inscripcionequipo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `partidos`
  MODIFY `id_partidos` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
