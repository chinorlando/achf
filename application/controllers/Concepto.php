...
class Concepto extends CI_Controller {
    ...
    public function __construct() {
        ...
        parent::__construct();
        $this->load->Model('Concepto_model','dbase');
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $d) {
            ...
            $row[] = '  <button type="button" class="mb-xs mt-xs mr-xs btn btn-xs btn-info" onclick="view_row('.$d->id_concepto.')">
                            <i class="fa fa-eye"></i>
                        </button>       
                        <button type="button" class="mb-xs mt-xs mr-xs btn btn-xs btn-info" onclick="edit_row('.$d->id_concepto.')">
                            <i class="fa fa-pencil"></i>
                        </button>    
                        <!--
                        <button type="button" class="mb-xs mt-xs mr-xs btn btn-xs btn-info" onclick="delete_row('.$d->id_concepto.')">
    ...
    public function ajax_update()
    {
        $this->_validate();
        $data = $this->post_data();
        $this->dbase->update($this->input->post('id_concepto'), $data);
        echo json_encode(array("status" => TRUE));
    }
