...
--
-- Servidor: localhost
-- Tiempo de generación: 09-10-2020 a las 01:51:21
-- Versión del servidor: 8.0.21-0ubuntu0.20.04.4
-- Versión de PHP: 5.6.40-30+ubuntu20.04.1+deb.sury.org+1
...
CREATE TABLE `arbitro_partido` (
  `id_arbitropartido` int NOT NULL,
  `id_partidos` int NOT NULL,
  `id_arbitro` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
CREATE TABLE `cargo` (
  ...
  `estado` char(1) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
CREATE TABLE `categoria` (
  ...
  `nombre` varchar(150) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
...
CREATE TABLE `categoriasorteado` (
  `id_categoriasorteado` int NOT NULL,
  `fecha_sorteo` date NOT NULL,
  `id_categoria` int NOT NULL,
  `id_torneo` int NOT NULL,
  `sorteado` tinyint DEFAULT NULL COMMENT '1=equipos sorteados. 0=equipos no sorteados'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
CREATE TABLE `club` (
  ...
  `nombre_club` varchar(100) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL,
  `direccion` varchar(100) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL,
  `ciudad` varchar(50) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL,
  `escudo` varchar(50) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL,
...
(1, 7, 'BOLIVAR', 'OSTRIA GUTIERREZ # 585', 'LA PAZ', 'c08cb-a7f45-club_bolivar.png', '1925-04-12', 1),
(2, 8, 'THE STRONGEST', 'PANDO # 321', 'LA PAZ', 'af3d7-487dc-club_the_strongest.png', '1908-04-08', 1),
(3, 9, 'SAN JOSE', 'AV. LIBERTADORES # 12', 'ORURO', '1ff3c-309b0-san-jose.png', '1942-03-19', 1),
(4, 10, 'BLOOMING', 'MARCELO QUIROGA # 225', 'SANTA CRUZ', '2277f-def07-club-blooming.png', '1956-05-01', 1),
(5, 11, 'WILSTERMAN', 'SONA LAJASTAMBO # 1115', 'COCHABAMBA', '', '1949-11-24', 1),
(6, 12, 'ORIENTE PETROLERO', 'CANADA # 2225', 'SANTA CRUZ', '', '1995-11-05', 1),
...
CREATE TABLE `curriculo_jugador` (
  `id_currijugador` int NOT NULL,
  `id_jugador` int NOT NULL,
  `informacion` varchar(250) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `trayectoria` varchar(250) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `logros` varchar(150) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `palmares` varchar(150) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `foto` varchar(250) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT 'user.jpg',
  `estado` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
CREATE TABLE `equipo` (
  ...
  `genero` char(1) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL,
...
INSERT INTO `equipo` (`id_equipo`, `genero`, `id_personacargo`, `id_club`, `id_categoria`) VALUES
(1, 'M', 7, 1, 1),
(2, 'M', 8, 2, 1),
(3, 'M', 9, 3, 1),
(4, 'M', 10, 4, 1),
...
CREATE TABLE `estadio` (
  ...
  `nombreestadio` varchar(200) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `capacidad` varchar(200) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `ciudad` varchar(150) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `direccion` varchar(150) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `foto` varchar(250) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT 'estadio.jpg',
...
(1, 'ESTADIO PATRIA', '32700', 'Chuquisaca', 'AV. JAIME MENDOZA # 3352', '8e0f9-3.png', NULL, 1),
(2, 'ESTADIO SUCRE', '25000', NULL, 'AV. DEL MAESTRO # 152', NULL, NULL, 1),
(3, 'ESTADIO LOURDES DE YOTALA', '6500', NULL, 'REYES # 2352', NULL, NULL, 1),
(4, 'HERNANDO SILES', '45000', 'La Paz', 'AV. LOS ANDES # 1352', NULL, NULL, 1),
(5, 'VILLA INGENIO', '25000', 'LA PAZ', 'AV. ALTO DE ALIENZA # 352', '', '2000-01-01', 1),
(6, 'JESUS BERMUDES', '30000', NULL, 'JAIME MENDOZA # 3544', NULL, '2000-01-01', 1),
...
CREATE TABLE `games` (
  ...
  `hscore` tinyint DEFAULT NULL,
  `ascore` tinyint DEFAULT NULL,
  `id_equipo_h` int DEFAULT NULL,
  `id_equipo_a` int DEFAULT NULL,
  `id_partidos` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
INSERT INTO `inscripcionequipo` (`id_inscripcionequipo`, `fecha`, `num_bolo`, `id_equipo`, `id_torneo`) VALUES
(1, '2020-06-12', 1, 1, 1),
(2, '2020-06-12', 2, 2, 1),
(3, '2020-06-12', 3, 3, 1),
(4, '2020-06-12', 4, 4, 1),
...
(8, '2020-06-12', 8, 8, 1),
(9, '2020-06-12', 9, 9, 1),
(10, '1999-06-12', 4, 10, 1),
(11, '1999-06-12', 1, 11, 1),
(12, '1999-06-12', 2, 12, 1),
(13, '1999-06-12', 3, 13, 1),
(14, '1999-06-12', 4, 14, 1);
...
CREATE TABLE `inscripcionjugador` (
  `id_inscripcionjugador` int NOT NULL,
  `dorsal` int NOT NULL,
  `posicion` varchar(100) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL,
  `peso` float NOT NULL,
  `id_jugador` int NOT NULL,
  `id_inscripcionequipo` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
CREATE TABLE `jugador` (
  `id_jugador` int NOT NULL,
  `id_persona` int NOT NULL,
  `n_registro_fbf` int DEFAULT NULL,
  `lfpb_asociacion_liga_provincial` varchar(250) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `nombre_padre` varchar(70) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `nombre_madre` varchar(70) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `estado_civil` varchar(50) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `c_i` varchar(30) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `estado` char(1) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `estatura` decimal(10,0) DEFAULT NULL,
  `cont_amarilla` tinyint NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
(376, 436, 3826425, 'ACHF', 'SALAZAR', 'GUTIERREZ', 'SOLTERO', '9852627', '1', '176', 1),
...
(380, 440, 4735220, 'ACHF', 'SOTO', 'GONZALES', 'SOLTERO', '4118968', '1', '180', 1),
(381, 441, 4876869, 'ACHF', 'CHIRARI', 'TABOADA', 'SOLTERO', '10361836', '1', '176', 1),
...
(421, 481, 4963207, 'ACHF', 'TELLEZ', 'PACO', 'SOLTERO', '12518124', '1', '178', 1),
...
CREATE TABLE `menus` (
  ...
  `directorio` varchar(150) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL,
  `icono` varchar(70) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `imagen` varchar(150) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `color` varchar(25) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `orden` int DEFAULT NULL,
  `estado` set('1','0') CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
(1, 1, 'Registrar Jugador', 'jugador', NULL, NULL, NULL, NULL, NULL),
(2, 1, 'nombre correcto->(Asignar un jugador a un equipo de un club) - borrar->Registrar una categoria de un club', 'jugador/equipo_jugador', NULL, NULL, NULL, NULL, NULL),
(3, 1, 'Curriculo_Jugador', 'Curriculo', '4', '4', '4', 4, NULL),
(4, 1, 'Trasferencias', 'jugador/transferencias', '1', '1', '1', 1, NULL),
(5, 2, 'Club', 'registro/club', NULL, NULL, NULL, NULL, NULL),
(6, 2, 'Categoria', 'registro/categoria', NULL, NULL, NULL, NULL, NULL),
(7, 2, 'Equipo', 'registro/equipo', NULL, NULL, NULL, NULL, NULL),
(8, 3, 'Estadios', 'registro/estadio', NULL, NULL, NULL, NULL, NULL),
(9, 4, 'Torneo', 'registro/torneo', NULL, NULL, NULL, NULL, NULL),
(10, 4, 'Inscripciones', 'planillero/inscripcion_equipo', NULL, NULL, NULL, NULL, NULL),
(11, 4, 'Sorteos', 'planillero', '6', '6', '6', 6, NULL),
(12, 4, 'Rol de partidos', 'planillero/rol_partidos', '7', '7', '7', 7, NULL),
(13, 4, 'Tabla de Posiciones', 'planillero/tabla_posiciones', NULL, NULL, NULL, NULL, NULL),
(14, 4, 'Habilitar jugadores', 'planillero/habilitacion', NULL, NULL, NULL, NULL, '1'),
(15, 5, 'Categoria_Arbitro', 'Categoria_Arbitro', '1', '1', '1', 1, NULL),
(16, 5, 'Árbitro', 'registro/arbitro', NULL, NULL, NULL, NULL, NULL),
(17, 5, 'Partidos de árbitro', 'registro/partidos_arbitro', NULL, NULL, NULL, NULL, NULL),
(18, 5, 'Planillero', 'registro/planillero', NULL, NULL, NULL, NULL, NULL),
(19, 5, 'Asignacion de árbitros', 'planillero/asignacion_arbitros', NULL, NULL, NULL, NULL, NULL),
(20, 7, 'Concepto de...', 'registro/concepto', NULL, NULL, NULL, NULL, NULL),
(21, 7, 'Asignar precios', 'registro/precio_concepto', NULL, NULL, NULL, NULL, NULL),
(22, 7, 'Pagos', 'planillero/pagos', NULL, NULL, NULL, NULL, NULL),
(23, 8, 'Persona', 'registro/persona', NULL, NULL, NULL, 2, '1'),
(24, 8, 'Cambiar contraseña', 'registro/usuario', NULL, NULL, NULL, NULL, NULL),
(25, 9, 'Persona - Cargo', 'registro/persona_cargo', NULL, NULL, NULL, 1, '1'),
(26, 9, 'Roles', 'registro/roles', NULL, NULL, NULL, 1, ''),
(27, 9, 'Asignacion roles', 'registro/persona_roles', NULL, NULL, NULL, NULL, ''),
(28, 10, 'Menu principal', 'registro/menus_principales', NULL, NULL, NULL, NULL, ''),
(29, 10, 'Submenus', 'registro/menus', NULL, NULL, NULL, NULL, ''),
(30, 10, 'Asignacion Menu Prin.', 'registro/roles_menus_principales', NULL, NULL, NULL, NULL, '1'),
(31, 10, 'Asignacion menu usuario', 'Menu_Opciones/asignacion', NULL, NULL, NULL, NULL, '1'),
(32, 11, 'PAGOS', 'reporte/detalle', NULL, NULL, NULL, NULL, '1'),
(33, 11, 'Jugadores', 'reporte/jugador', NULL, NULL, NULL, NULL, '1'),
(60, 45, 'Torneo', 'Torneo', '2', '2', '2', 2, NULL),
(61, 45, 'Categoria', 'Categoria', '2', '2', '2', 2, NULL),
(70, 45, 'Categoría de árbitro', 'registro/categoria_arbitro', NULL, NULL, NULL, NULL, NULL);
...
(5, 'ARBITROS/PLANILLEROS', '5', '5', 5, '1'),
(7, 'ADMINISTRACIÓN ', '7', '7', 7, '1'),
(8, 'USUARIOS', '8', '8', 8, '1'),
(9, 'REGISTROS', '9', '9', 9, '1'),
...
(8, '2020-09-16', 7100, '', 1),
(9, '2020-10-08', 1403, '', 1),
(10, '2020-10-09', 2803, '', 1),
(11, '2020-10-09', 300, '', 1),
(12, '2020-10-09', 3113, '', 1),
(13, '2020-10-09', 10, '', 2);
...
CREATE TABLE `partidos` (
  ...
  `observaciones` varchar(350) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `estado` int DEFAULT NULL,
  `id_planillero` int DEFAULT NULL,
  `id_inscripcion1` int NOT NULL,
  `id_inscripcion2` int NOT NULL,
...
(214, 1, '2020-09-16 16:21:00', NULL, 1, 3, 2, 1, 1, 1),
(215, 1, NULL, NULL, NULL, NULL, 5, 7, NULL, 1),
(216, 1, NULL, NULL, NULL, NULL, 8, 4, NULL, 1),
(217, 1, NULL, NULL, NULL, NULL, 9, 3, NULL, 1),
(218, 2, NULL, NULL, NULL, NULL, 3, 1, NULL, 1),
(219, 2, NULL, NULL, NULL, NULL, 5, 6, NULL, 1),
(220, 2, NULL, NULL, NULL, NULL, 8, 7, NULL, 1),
(221, 2, NULL, NULL, NULL, NULL, 9, 4, NULL, 1),
(222, 3, NULL, NULL, NULL, NULL, 3, 2, NULL, 1),
(223, 3, NULL, NULL, NULL, NULL, 4, 1, NULL, 1),
(224, 3, NULL, NULL, NULL, NULL, 8, 6, NULL, 1),
(225, 3, NULL, NULL, NULL, NULL, 9, 7, NULL, 1),
(226, 4, NULL, NULL, NULL, NULL, 4, 2, NULL, 1),
(227, 4, NULL, NULL, NULL, NULL, 7, 1, NULL, 1),
(228, 4, NULL, NULL, NULL, NULL, 8, 5, NULL, 1),
(229, 4, NULL, NULL, NULL, NULL, 9, 6, NULL, 1),
(230, 5, NULL, NULL, NULL, NULL, 4, 3, NULL, 1),
(231, 5, NULL, NULL, NULL, NULL, 7, 2, NULL, 1),
(232, 5, NULL, NULL, NULL, NULL, 6, 1, NULL, 1),
(233, 5, NULL, NULL, NULL, NULL, 9, 5, NULL, 1),
(234, 6, NULL, NULL, NULL, NULL, 7, 3, NULL, 1),
(235, 6, NULL, NULL, NULL, NULL, 6, 2, NULL, 1),
(236, 6, NULL, NULL, NULL, NULL, 5, 1, NULL, 1),
(237, 6, NULL, NULL, NULL, NULL, 9, 8, NULL, 1),
(238, 7, NULL, NULL, NULL, NULL, 7, 4, NULL, 1),
(239, 7, NULL, NULL, NULL, NULL, 6, 3, NULL, 1),
(240, 7, NULL, NULL, NULL, NULL, 5, 2, NULL, 1),
(241, 7, NULL, NULL, NULL, NULL, 8, 1, NULL, 1),
(242, 8, NULL, NULL, NULL, NULL, 6, 4, NULL, 1),
(243, 8, NULL, NULL, NULL, NULL, 5, 3, NULL, 1),
(244, 8, NULL, NULL, NULL, NULL, 8, 2, NULL, 1),
(245, 8, NULL, NULL, NULL, NULL, 9, 1, NULL, 1),
(246, 9, NULL, NULL, NULL, NULL, 6, 7, NULL, 1),
(247, 9, NULL, NULL, NULL, NULL, 5, 4, NULL, 1),
(248, 9, NULL, NULL, NULL, NULL, 8, 3, NULL, 1),
(249, 9, NULL, NULL, NULL, NULL, 9, 2, NULL, 1);
...
CREATE TABLE `persona` (
  `id_persona` int NOT NULL,
  `nombres` varchar(70) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `apellido_paterno` varchar(70) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `apellido_materno` varchar(70) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `foto` varchar(255) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT 'user.jpg',
  `telefono` varchar(25) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `celular` varchar(25) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  ...
  `sexo` varchar(1) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `profesion` varchar(50) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `nacionalidad` varchar(100) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `email` varchar(150) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `usuario` varchar(150) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `password` varchar(250) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
INSERT INTO `persona` (`id_persona`, `nombres`, `apellido_paterno`, `apellido_materno`, `foto`, `telefono`, `celular`, `direccion`, `ciudad`, `fecha_nacimiento`, `sexo`, `profesion`, `nacionalidad`, `email`, `usuario`, `password`) VALUES
(1, 'Carlos Alfredo', 'Ortega', 'Orellana', '3aaae-1.jpeg', '064-65425', '60322860', 'Ostria Reyes # 125', NULL, '2000-02-02', 'M', 'Estudiante', 'bolivia', 'admin@gmail.com', 'admin', 'd033e22ae348aeb5660fc2140aec35850c4da997'),
...
(3, 'REYNA', 'LOPEZ', 'ROZALES', '', '064-4489106', '75689436', 'Ostria Reyes # 125', 'CHUQUISACA', '1963-12-01', 'F', 'SECRETARIA', 'BOLIVIA', 'secre@gmail.com', 'secre', 'd033e22ae348aeb5660fc2140aec35850c4da997'),
...
(6, 'SAID', 'SALAZAR', 'CUEVAS', '', '064-4489106', '75689436', 'Ostria Reyes # 125', 'CHUQUISACA', '1969-09-20', 'M', 'PROFESOR', 'BOLIVIA', 'profe@gmail.com', 'ComTec', 'd033e22ae348aeb5660fc2140aec35850c4da997'),
...
(436, 'ALVARO', 'SALAZAR', 'GUTIERREZ', 'e6fad-4.png', '064-32541', ' 71202014', 'GUILLERMO LOAIZA # 258', NULL, '2000-01-01', 'M', 'FUTBOLISTA', 'BOLIVIA', 'futbol@gmail.com', '', '10a34637ad661d98ba3344717656fcc76209c2f8'),
(437, 'DIEGO NAZARIO', 'CESPEDES', 'LAZO', 'a99b8-3.png', '064-32541', ' 71202014', 'GUILLERMO LOAIZA # 258', NULL, '2020-09-20', 'M', 'FUTBOLISTA', 'BOLIVIA', 'futbol@gmail.com', '', ''),
(438, 'KEVIN RENATO', 'TORRES', 'MIRANDA', 'cf1f9-2.png', '064-32541', ' 71202014', 'GUILLERMO LOAIZA # 258', NULL, '2011-10-20', 'M', 'FUTBOLISTA', 'BOLIVIA', 'futbol@gmail.com', '', ''),
...
(720, 'NOEL FERNANDO', 'LLANQUI', 'COLQUE', NULL, '064-32541', '75849632', 'Montero', NULL, '2000-06-10', 'M', NULL, 'BOLIVIA', 'futbol@gmail.com', NULL, 'da39a3ee5e6b4b0d3255bfef95601890afd80709'),
(721, 'aaaa', 'aaaa', 'aaaa', '', '', '', '', '', '0000-00-00', '', '', '', '', '', 'da39a3ee5e6b4b0d3255bfef95601890afd80709');
...
CREATE TABLE `planillero` (
  `id_planillero` int NOT NULL,
  `id_persona` int NOT NULL,
  `disciplinas` varchar(100) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `observaciones` varchar(250) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `estado` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
CREATE TABLE `resultado_partido` (
  `id_resultadopartido` int NOT NULL,
  `id_jugador` int NOT NULL,
  `id_partidos` int NOT NULL,
  `accion` int NOT NULL COMMENT '1=amarilla\r\n2=roja\r\n3=gol',
  `pagado` int DEFAULT NULL COMMENT '0=no pagado por amarilla, 1=pagado por amarilla',
  `minuto` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
CREATE TABLE `suspencion` (
  ...
  `motivo` varchar(1) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL,
  `id_jugador` int NOT NULL,
  `id_partidos` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
INSERT INTO `suspencion` (`id_suspencion`, `cantpart`, `motivo`, `id_jugador`, `id_partidos`) VALUES
(17, 1, 'd', 376, 214);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `suspencion_partido`
--

CREATE TABLE `suspencion_partido` (
  `id_suspencionpartido` int NOT NULL,
  `id_partidos` int NOT NULL,
  `observaciones` text CHARACTER SET latin1 COLLATE latin1_spanish_ci,
  `fecha_reprogramacion` datetime DEFAULT NULL,
  `estado_sus` tinyint DEFAULT NULL COMMENT '1=partido reprogramado finalizado 0=sigue suspendido el partido'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
CREATE TABLE `torneo` (
  `id_torneo` int NOT NULL,
  `nombretorneo` varchar(255) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL,
  `fecha_inicio` date DEFAULT NULL,
  `fecha_fin` date DEFAULT NULL,
  `estado` int DEFAULT NULL COMMENT '0=Finalizado 1=No Finalizado'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
(1, 'Libertad', '2020-07-06', '2020-07-14', 1);
...
CREATE TABLE `transferencias` (
  `id_transferencias` int NOT NULL,
  `fecha` date NOT NULL,
  `id_jugador` int NOT NULL,
  `id_club` int NOT NULL,
...
(2, '2020-10-09', 376, 1, 13, 313, 0),
(3, '2020-10-09', 376, 13, 4, 313, 0),
(4, '2020-10-09', 376, 4, 3, 313, 0);
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_equipo`  AS  select `equipo`.`id_equipo` AS `id_equipo`,`club`.`nombre_club` AS `nombre_club`,`categoria`.`nombre` AS `nombre` from (((`inscripcionequipo` join `equipo` on((`equipo`.`id_equipo` = `inscripcionequipo`.`id_equipo`))) join `club` on((`club`.`id_club` = `equipo`.`id_club`))) join `categoria` on((`categoria`.`id_categoria` = `equipo`.`id_categoria`))) group by `equipo`.`id_equipo` ;
...
ALTER TABLE `equipo`
  ...
  ADD KEY `fk_equipo_persona` (`id_personacargo`),
  ADD KEY `fk_equipo_club` (`id_club`),
...
ALTER TABLE `inscripcionequipo`
  ...
  ADD KEY `fk_inscripcionequipo_equipo` (`id_equipo`),
...
--
-- Indices de la tabla `suspencion_partido`
--
ALTER TABLE `suspencion_partido`
  ADD PRIMARY KEY (`id_suspencionpartido`),
  ADD KEY `fk_suspencionpartido_partido` (`id_partidos`);
...
--
ALTER TABLE `arbitro`
  MODIFY `id_arbitro` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `arbitro_partido`
--
ALTER TABLE `arbitro_partido`
  MODIFY `id_arbitropartido` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `categoriasorteado`
  MODIFY `id_categoriasorteado` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `categoria_arbitro`
--
ALTER TABLE `categoria_arbitro`
  MODIFY `id_catarbitro` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `costos`
  MODIFY `id_costos` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `curriculo_jugador`
--
ALTER TABLE `curriculo_jugador`
  MODIFY `id_currijugador` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=317;

--
-- AUTO_INCREMENT de la tabla `equipo`
--
ALTER TABLE `equipo`
  MODIFY `id_equipo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT de la tabla `estadio`
--
ALTER TABLE `estadio`
  MODIFY `id_estadio` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `games`
--
ALTER TABLE `games`
  MODIFY `id_games` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `habilitado`
--
ALTER TABLE `habilitado`
  MODIFY `id_habilitado` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;

--
-- AUTO_INCREMENT de la tabla `inscripcionequipo`
--
ALTER TABLE `inscripcionequipo`
  MODIFY `id_inscripcionequipo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT de la tabla `inscripcionjugador`
--
ALTER TABLE `inscripcionjugador`
  MODIFY `id_inscripcionjugador` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;

--
-- AUTO_INCREMENT de la tabla `jugador`
--
ALTER TABLE `jugador`
  MODIFY `id_jugador` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=662;
...
--
ALTER TABLE `motivo`
  MODIFY `id_motivo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT de la tabla `pago`
--
ALTER TABLE `pago`
  MODIFY `id_pago` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;

--
-- AUTO_INCREMENT de la tabla `pagogeneral`
--
ALTER TABLE `pagogeneral`
  MODIFY `id_pagogeneral` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT de la tabla `partidos`
--
ALTER TABLE `partidos`
  MODIFY `id_partidos` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=250;

--
-- AUTO_INCREMENT de la tabla `persona`
--
ALTER TABLE `persona`
  MODIFY `id_persona` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=722;
...
--
ALTER TABLE `persona_cargo`
  MODIFY `id_personacargo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;

--
-- AUTO_INCREMENT de la tabla `planillero`
--
ALTER TABLE `planillero`
  MODIFY `id_planillero` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `precio_concepto`
--
ALTER TABLE `precio_concepto`
  MODIFY `id_precioconcepto` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=570;

--
-- AUTO_INCREMENT de la tabla `resultado_partido`
--
ALTER TABLE `resultado_partido`
  MODIFY `id_resultadopartido` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
...
--
ALTER TABLE `suspencion`
  MODIFY `id_suspencion` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT de la tabla `suspencion_partido`
--
ALTER TABLE `suspencion_partido`
  MODIFY `id_suspencionpartido` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `transferencias`
  MODIFY `id_transferencias` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
