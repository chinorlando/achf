...
--
-- Servidor: localhost
-- Tiempo de generación: 01-08-2020 a las 19:00:24
...
--
ALTER TABLE `categoriasorteado`
  MODIFY `id_categoriasorteado` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `partidos`
  MODIFY `id_partidos` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=169;
