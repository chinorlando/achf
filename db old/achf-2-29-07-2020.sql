...
--
-- Servidor: localhost
-- Tiempo de generación: 29-07-2020 a las 02:10:35
...
(1, 'Libertad', '2020-07-05', '2020-07-25', 1);
...
--
ALTER TABLE `equipo`
  MODIFY `id_equipo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `persona`
  MODIFY `id_persona` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=721;
