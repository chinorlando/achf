...
--
-- Servidor: localhost
-- Tiempo de generación: 09-03-2020 a las 15:16:56
...
(1, 'INSCRIPCIONES ', 1),
(2, 'DERECHO DE JUGADOR ', 1),
(3, 'PLANILLAS', 1),
(4, 'TARJETAS DE ACTUACIÓN ', 1),
(5, 'OBSERVACIONES', 1),
(6, 'TARJETAS AMARILLAS', 1),
(7, 'FICHAS KARDEX', 1);
...
(1, 0, 2, 1, 1, 0, NULL, NULL, NULL),
(2, 0, 8, 6, 1, 0, NULL, NULL, NULL),
(3, 0, 9, 5, 1, 0, NULL, NULL, NULL),
(4, 0, 10, 4, 1, 0, NULL, NULL, NULL),
(5, 0, 11, 3, 1, 0, NULL, NULL, NULL),
(6, 0, 12, 7, 1, 0, NULL, NULL, NULL),
...
--
ALTER TABLE `resultado_partido`
  MODIFY `id_resultadopartido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=462;
